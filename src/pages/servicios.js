...
import { Truck, PackageCheck, Clock, Headset, ClipboardCheck, Star, Instagram, Facebook, Send } from 'lucide-react';
...
export default function Servicios() {
  const servicios = [
    ...
    },
    {
      ...
      title: "Entrega 24/7",
      description: "Servicio de entrega disponible las 24 horas para satisfacer las necesidades urgentes de nuestros clientes comerciales."
    },
    {
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex flex-col items-center md:items-end">
              ...
              <div className="flex space-x-4">
                ...
                <motion.a
                  href="https://facebook.com/alenort"
                  whileHover={{ scale: 1.2, rotate: -15 }}
                  whileTap={{ scale: 0.9 }}
                  className="bg-yellow-500 p-3 rounded-full hover:bg-yellow-400 transition-colors duration-300"
                >
