...
export default function Contacto() {
  ...
  const infoContacto = [
    ...
    { icon: <Mail className="w-6 h-6 text-yellow-600" />, titulo: "Email", detalle: "contacto@alenort.com" },
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-6 md:mb-0">
              <img src="alenort3.png" alt="Alenort Logo" className="h-12" />
              <p className="mt-3 text-sm text-gray-400 max-w-md">
                Líderes en distribución avícola, llevando calidad y frescura a todo el país desde 1995.
              </p>
            </div>
            ...
            <div className="flex flex-col items-center md:items-end">
              ...
              <div className="flex space-x-4">
                ...
                <a href="https://facebook.com/alenort" className="text-gray-400 hover:text-yellow-500 transition-colors">
                  <Facebook className="w-6 h-6" />
                </a>
                <a href="https://wa.me/5493812224766" className="text-gray-400 hover:text-yellow-500 transition-colors">
